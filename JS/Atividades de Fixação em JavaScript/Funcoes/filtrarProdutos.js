...
baratos que o valor passado como parâmetro. Outro programador já criou uma função maisCarosQue(valor, precos) que retorna
 um array com os preços mais caros que o valor passado como parâmetro. Chegou sua vez!
...
Dicas:
Para utilizar uma função não é necessário o comando function, somente o nome da função seguido de parênteses e parâmetros
se necessário.
