...
Cada filme tem um grande array de notas atribuídas pelos visitantes. Contudo, além de dar notas para os filmes, os 
visitantes querem ver o que as outras pessoas acharam do filme! É aí que você entra com seu código:

Escreva uma função calculaGostos(notas)
Essa função deve ser escrita para receber somente um parâmetro: um array de notas. Ela deve retornar também um array 
com três elementos:
...
Dicas:
Você pode criar três variáveis: Uma para contar quantos não gostaram, outra para contar quantos acharam mediano e uma
 terceira para contar quantas gostaram do filme. Você pode retornar um array assim: 
